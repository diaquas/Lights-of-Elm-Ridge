  ...
  return (
    ...
    >
      ...
      <input
        ...
        required
        aria-required="true"
        className="flex-1 px-4 py-3 bg-surface border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent"
      />
      <button
        type="submit"
        disabled={status === "submitting"}
        className="px-6 py-3 bg-accent hover:bg-accent/80 disabled:bg-accent/50 text-white font-semibold rounded-lg transition-colors"
      >
