...
const INSIGHTS = [
  { text: "Demucs is an AI model by Meta that can listen to a full mix and pull apart vocals, drums, bass, and melody \u2014 like unmixing paint.", bold: "Demucs" },
  ...
  { text: "Your finished file contains 5 separate timing tracks you can layer in xLights \u2014 beats, downbeats, phrases, vocals, and energy peaks.", bold: "5 separate timing tracks" },
  ...
  { text: "Energy peaks mark the loudest, most intense moments in your track \u2014 perfect for triggering your biggest lighting effects.", bold: "triggering your biggest lighting effects" },
        ...
        {!showCompletion && firstStarted && (
          <div className="text-center space-y-1 pb-4">
            ...
            <p className="text-xs text-foreground/15">
              ...
              <span className="text-green-500/70 font-semibold">~2.5 hours</span>
