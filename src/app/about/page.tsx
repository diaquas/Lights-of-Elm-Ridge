...
const timeline = [
  ...
  },
  {
    ...
    title: "What's Next",
    description:
      "Already planned—upgrading to a P5 panel matrix and taking full advantage of the 260-foot wide front yard. Mockup coming soon.",
  },
];
...
const services = [
  {
    ...
    description:
      "Got a song stuck in your head? We'll bring it to life with a sequence built specifically for your display.",
  ...
  },
  {
    ...
    description:
      "Already bought a sequence that doesn't quite fit? We'll map it to your specific layout.",
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-6">
              ...
              <div className="md:w-2/3 space-y-4 text-foreground/70 leading-relaxed">
                ...
                <p>
                  ...
                  thick woods between) had one of the biggest light displays in
                  the area. We saw it almost every night, and I could always
                  catch the glow through the trees when the leaves fell.
                </p>
                <p>
                  I wouldn&apos;t say I was obsessed—but I was definitely
                  enamored and intrigued. Thinking about how to wire all of that
                  up and get it to actually work was genuinely exciting. My
                  brother and I would draw her house on a school-sized
                  chalkboard in our playroom. Those were the days of old school
                  blow molds, C9 AC lights, and everything else that existed in
                  outdoor lighting before pixels and controllers and the
                  internet took over the hobby. She was a true pioneer.
                </p>
                <p>
                  I suppose I kept those memories stored away for 30 years. But
                  for some unknown reason, a part of me who saw those lights in
                  the &apos;80s and &apos;90s wanted to give it a go—but in the
                  modern world. It&apos;s equal parts self-satisfaction (proving
                  I could actually do it) and watching the next generation adore
                  the glow and allure of the dancing lights. It brought me so
                  much joy in my youth; I figured it was time to pay it forward.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  {/* Content */}
                  <div
                    className={`flex-1 ml-12 md:ml-0 ${index % 2 === 0 ? "md:pr-12 md:text-right" : "md:pl-12"}`}
                  >
        ...
        <section id="services" className="mb-16 scroll-mt-24">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            {services.map((service) => (
              <div
                key={service.title}
                className="bg-surface rounded-xl p-4 sm:p-6 border border-border card-hover"
              >
                ...
                <p className="text-foreground/60 text-xs sm:text-sm mb-4">
                  {service.description}
                </p>
          ...
          <div className="mt-8 bg-surface-light rounded-xl p-6 border border-border">
            ...
            <p className="mt-4 text-foreground/50 text-sm">
              ...
              Complex custom sequences during October/November are basically
              impossible—plan ahead!
            </p>
          </div>
        </section>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-foreground/60 text-sm">
                  There&apos;s room for everyone in this hobby. I share what I
                  know because others did the same for me.
                </p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-foreground/60 text-sm">
                  I won&apos;t sell something I wouldn&apos;t use in my own
                  show. Every sequence gets the same attention to detail.
                </p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-foreground/60 text-sm">
                  This is supposed to be enjoyable. If we can&apos;t laugh at
                  our mistakes and celebrate our wins, what&apos;s the point?
                </p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-foreground/60 text-sm">
                  I&apos;ll tell you what I actually think, not just what you
                  want to hear. Sometimes that means &quot;you don&apos;t need
                  that&quot; or &quot;start smaller.&quot;
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-surface rounded-xl p-6 border border-border">
              ...
              <p className="text-foreground/60 mt-2 text-sm">
                I have in the past! Reach out with details and we can discuss.
                Fair warning: commercial work takes priority booking and has
                different pricing.
              </p>
            </div>
            <div className="bg-surface rounded-xl p-6 border border-border">
              ...
              <p className="text-foreground/60 mt-2 text-sm">
                ...
                receivers for pixel pushing, and a whole lot of spreadsheets for
                planning. Details in the Behind the Scenes content!
              </p>
            </div>
          </div>
        </section>
