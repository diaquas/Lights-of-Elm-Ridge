...
export const SOURCE_MODELS: SourceModel[] = [
  ...
  // ── Eaves (Roofline) — pixel counts from xlights_rgbeffects.xml ──
  ...(
    [
      ["Eave 1- Office Left", 88],
      ["Eave 2 - Office Peak 1", 54],
      ["Eave 3 - Office Peak 2", 54],
      ["Eave 4 - Office Right", 40],
      ["Eave 5 - Entrance Arch", 30],
      ["Eave 6 - Tower Left", 72],
      ["Eave 7 - Tower Peak 1", 36],
      ["Eave 8 - Tower Peak 2", 36],
      ["Eave 9 - Upper Tower Right", 70],
      ["Eave 10 - Lower Tower Forward", 57],
      ["Eave 11 - Lower Tower Right", 62],
      ["Eave 12 - Avery Eave", 78],
      ["Eave 13 - Avery Right", 15],
      ["Eave 14 - Ellis Eave", 132],
      ["Eave 15 - Ellis Right", 72],
      ["Eave 16 - Guest Left", 48],
      ["Eave 17 - Guest Eave", 89],
      ["Eave 18 - Guest Right", 21],
      ["Eave 19 - Guest Bath", 54],
      ["Eave 20 - Guest Bath Right", 35],
      ["Eave 21 - Garage 1", 40],
      ["Eave 22 - Garage Left", 20],
      ["Eave 23 - Garage Peak 1", 48],
      ["Eave 24 - Garage Peak 2", 48],
      ["Eave 25 - Garage Right", 24],
      ["Eave 26 - Garage 2", 21],
    ] as const
  ).map(([name, px], i) => ({
    name,
  ...
  // ── Vertical Lines — pixel counts from xlights_rgbeffects.xml ──
  ...(
    [
      ["Vert 1 - Office 1", 75],
      ["Vert 2 - Office 2", 75],
      ["Vert 3 - Tower 1", 40],
      ["Vert 4 - Entrance 1", 59],
      ["Vert 5 - Entrance 2", 60],
      ["Vert 6 - Tower 2", 121],
      ["Vert 7 - Dining", 114],
      ["Vert 8 - Avery", 46],
      ["Vert 9 - Guest 1", 57],
