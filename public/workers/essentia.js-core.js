var Essentia = (function () {
  ...
  var Essentia = /** @class */ (function () {
     ...
     * @memberof Essentia
     */
    Essentia.prototype.getAudioBufferFromURL = function (
      audioURL,
      webAudioCtx,
    ) {
     ...
     * @memberof Essentia
     */
    Essentia.prototype.getAudioChannelDataFromURL = function (
      audioURL,
      webAudioCtx,
      channel,
    ) {
    ...
    Essentia.prototype.audioBufferToMonoSignal = function (buffer) {
      ...
      throw new Error(
        "Unexpected number of channels found in audio buffer. Only accepts mono or stereo audio buffers.",
      );
    };
    /**
     ...
     * @memberof Essentia
     */
    Essentia.prototype.FrameGenerator = function (
      inputAudioData,
      frameSize,
      hopSize,
    ) {
     ...
     * @memberof Essentia
     */
    Essentia.prototype.LoudnessEBUR128 = function (
      leftSignal,
      rightSignal,
      hopSize,
      sampleRate,
      ...
      return this.algorithms.LoudnessEBUR128(
        leftSignal,
        rightSignal,
        hopSize,
        sampleRate,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.AllPass = function (
      signal,
      bandwidth,
      cutoffFrequency,
      order,
      ...
      return this.algorithms.AllPass(
        signal,
        bandwidth,
        cutoffFrequency,
        order,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.AudioOnsetsMarker = function (
      signal,
      onsets,
      sampleRate,
      type,
      ...
      return this.algorithms.AudioOnsetsMarker(
        signal,
        veconsets,
        sampleRate,
        type,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.AutoCorrelation = function (
      array,
      ...
      return this.algorithms.AutoCorrelation(
        array,
        frequencyDomainCompression,
        generalized,
        normalization,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.BFCC = function (
      spectrum,
      dctType,
      highFrequencyBound,
      inputSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.BandPass = function (
      signal,
      bandwidth,
      cutoffFrequency,
      sampleRate,
      ...
      return this.algorithms.BandPass(
        signal,
        bandwidth,
        cutoffFrequency,
        sampleRate,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.BandReject = function (
      signal,
      bandwidth,
      cutoffFrequency,
      sampleRate,
      ...
      return this.algorithms.BandReject(
        signal,
        bandwidth,
        cutoffFrequency,
        sampleRate,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.BarkBands = function (
      spectrum,
      numberBands,
      sampleRate,
    ) {
     ...
     * @memberof Essentia
     */
    Essentia.prototype.BeatTrackerDegara = function (
      signal,
      maxTempo,
      minTempo,
    ) {
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.BeatTrackerMultiFeature = function (
      signal,
      maxTempo,
      minTempo,
    ) {
      ...
      return this.algorithms.BeatTrackerMultiFeature(
        signal,
        maxTempo,
        minTempo,
      );
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.Beatogram = function (
      loudness,
      loudnessBandRatio,
      size,
    ) {
     ...
     * @memberof Essentia
     */
    Essentia.prototype.BeatsLoudness = function (
      signal,
      beatDuration,
      beatWindowDuration,
      beats,
      ...
      return this.algorithms.BeatsLoudness(
        signal,
        beatDuration,
        beatWindowDuration,
        vecbeats,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.BpmRubato = function (
      beats,
      ...
      return this.algorithms.BpmRubato(
        beats,
        longRegionsPruningTime,
        shortRegionsMergingTime,
        tolerance,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.ChordsDetection = function (
      pcp,
      hopSize,
      sampleRate,
      windowSize,
      ...
      return this.algorithms.ChordsDetection(
        pcp,
        hopSize,
        sampleRate,
        windowSize,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.ChordsDetectionBeats = function (
      pcp,
      ticks,
      chromaPick,
      hopSize,
      ...
      return this.algorithms.ChordsDetectionBeats(
        pcp,
        ticks,
        chromaPick,
        hopSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.ChromaCrossSimilarity = function (
      queryFeature,
      referenceFeature,
      binarizePercentile,
      frameStackSize,
      ...
      return this.algorithms.ChromaCrossSimilarity(
        queryFeature,
        referenceFeature,
        binarizePercentile,
        frameStackSize,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.Chromagram = function (
      frame,
      binsPerOctave,
      minFrequency,
      minimumKernelSize,
      ...
      return this.algorithms.Chromagram(
        frame,
        binsPerOctave,
        minFrequency,
        minimumKernelSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.ClickDetector = function (
      frame,
      detectionThreshold,
      frameSize,
      hopSize,
      ...
      return this.algorithms.ClickDetector(
        frame,
        detectionThreshold,
        frameSize,
        hopSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.CoverSongSimilarity = function (
      inputArray,
      alignmentType,
      disExtension,
      disOnset,
      ...
      return this.algorithms.CoverSongSimilarity(
        inputArray,
        alignmentType,
        disExtension,
        disOnset,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.CrossCorrelation = function (
      arrayX,
      arrayY,
      maxLag,
      minLag,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.CrossSimilarityMatrix = function (
      queryFeature,
      referenceFeature,
      binarize,
      binarizePercentile,
      ...
      return this.algorithms.CrossSimilarityMatrix(
        queryFeature,
        referenceFeature,
        binarize,
        binarizePercentile,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.CubicSpline = function (
      x,
      leftBoundaryFlag,
      leftBoundaryValue,
      rightBoundaryFlag,
      ...
      return this.algorithms.CubicSpline(
        x,
        leftBoundaryFlag,
        leftBoundaryValue,
        rightBoundaryFlag,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.DCRemoval = function (
      signal,
      cutoffFrequency,
      sampleRate,
    ) {
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.DCT = function (
      array,
      dctType,
      inputSize,
      liftering,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Danceability = function (
      signal,
      maxTau,
      minTau,
      sampleRate,
      ...
      return this.algorithms.Danceability(
        signal,
        maxTau,
        minTau,
        sampleRate,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.DiscontinuityDetector = function (
      frame,
      detectionThreshold,
      energyThreshold,
      frameSize,
      ...
      return this.algorithms.DiscontinuityDetector(
        frame,
        detectionThreshold,
        energyThreshold,
        frameSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.DynamicComplexity = function (
      signal,
      frameSize,
      sampleRate,
    ) {
     ...
     * @memberof Essentia
     */
    Essentia.prototype.ERBBands = function (
      spectrum,
      highFrequencyBound,
      inputSize,
      lowFrequencyBound,
      ...
      return this.algorithms.ERBBands(
        spectrum,
        highFrequencyBound,
        inputSize,
        lowFrequencyBound,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.EffectiveDuration = function (
      signal,
      sampleRate,
      thresholdRatio,
    ) {
      ...
      return this.algorithms.EffectiveDuration(
        signal,
        sampleRate,
        thresholdRatio,
      );
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.EnergyBand = function (
      spectrum,
      sampleRate,
      ...
      return this.algorithms.EnergyBand(
        spectrum,
        sampleRate,
        startCutoffFrequency,
        stopCutoffFrequency,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.EnergyBandRatio = function (
      spectrum,
      sampleRate,
      startFrequency,
      stopFrequency,
      ...
      return this.algorithms.EnergyBandRatio(
        spectrum,
        sampleRate,
        startFrequency,
        stopFrequency,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Envelope = function (
      signal,
      applyRectification,
      attackTime,
      releaseTime,
      ...
      return this.algorithms.Envelope(
        signal,
        applyRectification,
        attackTime,
        releaseTime,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.FrameCutter = function (
      signal,
      frameSize,
      hopSize,
      ...
      return this.algorithms.FrameCutter(
        signal,
        frameSize,
        hopSize,
        lastFrameToEndOfFile,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.FrequencyBands = function (
      spectrum,
      frequencyBands,
      sampleRate,
    ) {
      if (frequencyBands === void 0) {
        frequencyBands = [
          0, 50, 100, 150, 200, 300, 400, 510, 630, 770, 920, 1080, 1270, 1480,
      ...
      return this.algorithms.FrequencyBands(
        spectrum,
        vecfrequencyBands,
        sampleRate,
      );
     ...
     * @memberof Essentia
     */
    Essentia.prototype.GFCC = function (
      spectrum,
      dctType,
      highFrequencyBound,
      inputSize,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.GapsDetector = function (
      frame,
      attackTime,
      frameSize,
      hopSize,
      ...
      return this.algorithms.GapsDetector(
        frame,
        attackTime,
        frameSize,
        hopSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.HPCP = function (
      frequencies,
      magnitudes,
      bandPreset,
      bandSplitFrequency,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.HarmonicBpm = function (
      bpms,
      bpm,
      threshold,
      tolerance,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.HarmonicPeaks = function (
      frequencies,
      magnitudes,
      pitch,
      maxHarmonics,
      ...
      return this.algorithms.HarmonicPeaks(
        frequencies,
        magnitudes,
        pitch,
        maxHarmonics,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.HighPass = function (
      signal,
      cutoffFrequency,
      sampleRate,
    ) {
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Histogram = function (
      array,
      maxValue,
      minValue,
      normalize,
      ...
      return this.algorithms.Histogram(
        array,
        maxValue,
        minValue,
        normalize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.HprModelAnal = function (
      frame,
      pitch,
      fftSize,
      freqDevOffset,
      ...
      return this.algorithms.HprModelAnal(
        frame,
        pitch,
        fftSize,
        freqDevOffset,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.HpsModelAnal = function (
      frame,
      pitch,
      fftSize,
      freqDevOffset,
      ...
      return this.algorithms.HpsModelAnal(
        frame,
        pitch,
        fftSize,
        freqDevOffset,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.IDCT = function (
      dct,
      dctType,
      inputSize,
      liftering,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Key = function (
      pcp,
      numHarmonics,
      pcpSize,
      profileType,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.KeyExtractor = function (
      audio,
      ...
      return this.algorithms.KeyExtractor(
        audio,
        averageDetuningCorrection,
        frameSize,
        hopSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Larm = function (
      signal,
      attackTime,
      power,
      releaseTime,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.LogAttackTime = function (
      signal,
      sampleRate,
      ...
      return this.algorithms.LogAttackTime(
        signal,
        sampleRate,
        startAttackThreshold,
        stopAttackThreshold,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.LogSpectrum = function (
      spectrum,
      binsPerSemitone,
      frameSize,
      rollOn,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.LoopBpmConfidence = function (
      signal,
      bpmEstimate,
      sampleRate,
    ) {
     ...
     * @memberof Essentia
     */
    Essentia.prototype.LoopBpmEstimator = function (
      signal,
      confidenceThreshold,
    ) {
     ...
     * @memberof Essentia
     */
    Essentia.prototype.LowLevelSpectralEqloudExtractor = function (
      signal,
      frameSize,
      hopSize,
      sampleRate,
      ...
      return this.algorithms.LowLevelSpectralEqloudExtractor(
        signal,
        frameSize,
        hopSize,
        sampleRate,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.LowLevelSpectralExtractor = function (
      signal,
      frameSize,
      hopSize,
      sampleRate,
      ...
      return this.algorithms.LowLevelSpectralExtractor(
        signal,
        frameSize,
        hopSize,
        sampleRate,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.LowPass = function (
      signal,
      cutoffFrequency,
      sampleRate,
    ) {
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.MFCC = function (
      spectrum,
      dctType,
      highFrequencyBound,
      inputSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.MelBands = function (
      spectrum,
      highFrequencyBound,
      inputSize,
      log,
      ...
      return this.algorithms.MelBands(
        spectrum,
        highFrequencyBound,
        inputSize,
        log,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.MultiPitchKlapuri = function (
      signal,
      binResolution,
      frameSize,
      harmonicWeight,
      ...
      return this.algorithms.MultiPitchKlapuri(
        signal,
        binResolution,
        frameSize,
        harmonicWeight,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.MultiPitchMelodia = function (
      signal,
      binResolution,
      filterIterations,
      frameSize,
      ...
      return this.algorithms.MultiPitchMelodia(
        signal,
        binResolution,
        filterIterations,
        frameSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Multiplexer = function (
      numberRealInputs,
      ...
      return this.algorithms.Multiplexer(
        numberRealInputs,
        numberVectorRealInputs,
      );
    };
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.NNLSChroma = function (
      logSpectrogram,
      meanTuning,
      localTuning,
      chromaNormalization,
      ...
      return this.algorithms.NNLSChroma(
        logSpectrogram,
        meanTuning,
        localTuning,
        chromaNormalization,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.NoiseBurstDetector = function (
      frame,
      alpha,
      silenceThreshold,
      threshold,
      ...
      return this.algorithms.NoiseBurstDetector(
        frame,
        alpha,
        silenceThreshold,
        threshold,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.NoveltyCurve = function (
      frequencyBands,
      frameRate,
      normalize,
      weightCurve,
      ...
      return this.algorithms.NoveltyCurve(
        frequencyBands,
        frameRate,
        normalize,
        vecweightCurve,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.NoveltyCurveFixedBpmEstimator = function (
      novelty,
      hopSize,
      maxBpm,
      minBpm,
      ...
      return this.algorithms.NoveltyCurveFixedBpmEstimator(
        novelty,
        hopSize,
        maxBpm,
        minBpm,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.OddToEvenHarmonicEnergyRatio = function (
      frequencies,
      magnitudes,
    ) {
      return this.algorithms.OddToEvenHarmonicEnergyRatio(
        frequencies,
        magnitudes,
      );
    };
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.OnsetDetection = function (
      spectrum,
      phase,
      method,
      sampleRate,
      ...
      return this.algorithms.OnsetDetection(
        spectrum,
        phase,
        method,
        sampleRate,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.OnsetDetectionGlobal = function (
      signal,
      frameSize,
      hopSize,
      method,
      ...
      return this.algorithms.OnsetDetectionGlobal(
        signal,
        frameSize,
        hopSize,
        method,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.OverlapAdd = function (
      signal,
      frameSize,
      gain,
      hopSize,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.PeakDetection = function (
      array,
      interpolate,
      maxPeaks,
      maxPosition,
      ...
      return this.algorithms.PeakDetection(
        array,
        interpolate,
        maxPeaks,
        maxPosition,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PercivalBpmEstimator = function (
      signal,
      frameSize,
      frameSizeOSS,
      hopSize,
      ...
      return this.algorithms.PercivalBpmEstimator(
        signal,
        frameSize,
        frameSizeOSS,
        hopSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchContourSegmentation = function (
      pitch,
      signal,
      hopSize,
      minDuration,
      ...
      return this.algorithms.PitchContourSegmentation(
        pitch,
        signal,
        hopSize,
        minDuration,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchContours = function (
      peakBins,
      peakSaliences,
      binResolution,
      hopSize,
      ...
      return this.algorithms.PitchContours(
        peakBins,
        peakSaliences,
        binResolution,
        hopSize,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.PitchContoursMelody = function (
      contoursBins,
      contoursSaliences,
      contoursStartTimes,
      duration,
      ...
      return this.algorithms.PitchContoursMelody(
        contoursBins,
        contoursSaliences,
        contoursStartTimes,
        duration,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.PitchContoursMonoMelody = function (
      contoursBins,
      contoursSaliences,
      contoursStartTimes,
      duration,
      ...
      return this.algorithms.PitchContoursMonoMelody(
        contoursBins,
        contoursSaliences,
        contoursStartTimes,
        duration,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.PitchContoursMultiMelody = function (
      contoursBins,
      contoursSaliences,
      contoursStartTimes,
      duration,
      ...
      return this.algorithms.PitchContoursMultiMelody(
        contoursBins,
        contoursSaliences,
        contoursStartTimes,
        duration,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchFilter = function (
      pitch,
      pitchConfidence,
      confidenceThreshold,
      minChunkSize,
      ...
      return this.algorithms.PitchFilter(
        pitch,
        pitchConfidence,
        confidenceThreshold,
        minChunkSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchMelodia = function (
      signal,
      binResolution,
      filterIterations,
      frameSize,
      ...
      return this.algorithms.PitchMelodia(
        signal,
        binResolution,
        filterIterations,
        frameSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchSalience = function (
      spectrum,
      highBoundary,
      lowBoundary,
      sampleRate,
      ...
      return this.algorithms.PitchSalience(
        spectrum,
        highBoundary,
        lowBoundary,
        sampleRate,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchSalienceFunction = function (
      frequencies,
      magnitudes,
      binResolution,
      harmonicWeight,
      ...
      return this.algorithms.PitchSalienceFunction(
        frequencies,
        magnitudes,
        binResolution,
        harmonicWeight,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchSalienceFunctionPeaks = function (
      salienceFunction,
      binResolution,
      maxFrequency,
      minFrequency,
      ...
      return this.algorithms.PitchSalienceFunctionPeaks(
        salienceFunction,
        binResolution,
        maxFrequency,
        minFrequency,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchYin = function (
      signal,
      frameSize,
      interpolate,
      maxFrequency,
      ...
      return this.algorithms.PitchYin(
        signal,
        frameSize,
        interpolate,
        maxFrequency,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchYinFFT = function (
      spectrum,
      frameSize,
      interpolate,
      maxFrequency,
      ...
      return this.algorithms.PitchYinFFT(
        spectrum,
        frameSize,
        interpolate,
        maxFrequency,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchYinProbabilistic = function (
      signal,
      frameSize,
      hopSize,
      lowRMSThreshold,
      ...
      return this.algorithms.PitchYinProbabilistic(
        signal,
        frameSize,
        hopSize,
        lowRMSThreshold,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchYinProbabilities = function (
      signal,
      frameSize,
      lowAmp,
      preciseTime,
      ...
      return this.algorithms.PitchYinProbabilities(
        signal,
        frameSize,
        lowAmp,
        preciseTime,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PitchYinProbabilitiesHMM = function (
      pitchCandidates,
      probabilities,
      minFrequency,
      ...
      return this.algorithms.PitchYinProbabilitiesHMM(
        pitchCandidates,
        probabilities,
        minFrequency,
        numberBinsPerSemitone,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.PredominantPitchMelodia = function (
      signal,
      binResolution,
      filterIterations,
      frameSize,
      ...
      return this.algorithms.PredominantPitchMelodia(
        signal,
        binResolution,
        filterIterations,
        frameSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Resample = function (
      signal,
      inputSampleRate,
      outputSampleRate,
      quality,
      ...
      return this.algorithms.Resample(
        signal,
        inputSampleRate,
        outputSampleRate,
        quality,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.RhythmExtractor = function (
      signal,
      frameHop,
      frameSize,
      hopSize,
      ...
      return this.algorithms.RhythmExtractor(
        signal,
        frameHop,
        frameSize,
        hopSize,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.RhythmExtractor2013 = function (
      signal,
      maxTempo,
      method,
      minTempo,
      ...
      return this.algorithms.RhythmExtractor2013(
        signal,
        maxTempo,
        method,
        minTempo,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.RhythmTransform = function (
      melBands,
      frameSize,
      hopSize,
    ) {
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.SNR = function (
      frame,
      MAAlpha,
      MMSEAlpha,
      NoiseAlpha,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.SaturationDetector = function (
      frame,
      ...
      return this.algorithms.SaturationDetector(
        frame,
        differentialThreshold,
        energyThreshold,
        frameSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Scale = function (
      signal,
      clipping,
      factor,
      maxAbsValue,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SineSubtraction = function (
      frame,
      magnitudes,
      frequencies,
      phases,
      ...
      return this.algorithms.SineSubtraction(
        frame,
        magnitudes,
        frequencies,
        phases,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SingleBeatLoudness = function (
      beat,
      beatDuration,
      beatWindowDuration,
      frequencyBands,
      ...
      return this.algorithms.SingleBeatLoudness(
        beat,
        beatDuration,
        beatWindowDuration,
        vecfrequencyBands,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Slicer = function (
      audio,
      endTimes,
      sampleRate,
      startTimes,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SpectralComplexity = function (
      spectrum,
      magnitudeThreshold,
      sampleRate,
    ) {
      ...
      return this.algorithms.SpectralComplexity(
        spectrum,
        magnitudeThreshold,
        sampleRate,
      );
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SpectralContrast = function (
      spectrum,
      frameSize,
      highFrequencyBound,
      lowFrequencyBound,
      ...
      return this.algorithms.SpectralContrast(
        spectrum,
        frameSize,
        highFrequencyBound,
        lowFrequencyBound,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SpectralPeaks = function (
      spectrum,
      magnitudeThreshold,
      maxFrequency,
      maxPeaks,
      ...
      return this.algorithms.SpectralPeaks(
        spectrum,
        magnitudeThreshold,
        maxFrequency,
        maxPeaks,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SpectralWhitening = function (
      spectrum,
      frequencies,
      magnitudes,
      maxFrequency,
      ...
      return this.algorithms.SpectralWhitening(
        spectrum,
        frequencies,
        magnitudes,
        maxFrequency,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.SpectrumCQ = function (
      frame,
      binsPerOctave,
      minFrequency,
      minimumKernelSize,
      ...
      return this.algorithms.SpectrumCQ(
        frame,
        binsPerOctave,
        minFrequency,
        minimumKernelSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SpectrumToCent = function (
      spectrum,
      bands,
      centBinResolution,
      inputSize,
      ...
      return this.algorithms.SpectrumToCent(
        spectrum,
        bands,
        centBinResolution,
        inputSize,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.Spline = function (
      x,
      beta1,
      beta2,
      type,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SprModelAnal = function (
      frame,
      fftSize,
      freqDevOffset,
      freqDevSlope,
      ...
      return this.algorithms.SprModelAnal(
        frame,
        fftSize,
        freqDevOffset,
        freqDevSlope,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SprModelSynth = function (
      magnitudes,
      frequencies,
      phases,
      res,
      ...
      return this.algorithms.SprModelSynth(
        magnitudes,
        frequencies,
        phases,
        res,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SpsModelAnal = function (
      frame,
      fftSize,
      freqDevOffset,
      freqDevSlope,
      ...
      return this.algorithms.SpsModelAnal(
        frame,
        fftSize,
        freqDevOffset,
        freqDevSlope,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SpsModelSynth = function (
      magnitudes,
      frequencies,
      phases,
      stocenv,
      ...
      return this.algorithms.SpsModelSynth(
        magnitudes,
        frequencies,
        phases,
        stocenv,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.StartStopCut = function (
      audio,
      frameSize,
      hopSize,
      maximumStartTime,
      ...
      return this.algorithms.StartStopCut(
        audio,
        frameSize,
        hopSize,
        maximumStartTime,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.StochasticModelAnal = function (
      frame,
      fftSize,
      hopSize,
      sampleRate,
      ...
      return this.algorithms.StochasticModelAnal(
        frame,
        fftSize,
        hopSize,
        sampleRate,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.StochasticModelSynth = function (
      stocenv,
      fftSize,
      hopSize,
      sampleRate,
      ...
      return this.algorithms.StochasticModelSynth(
        stocenv,
        fftSize,
        hopSize,
        sampleRate,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SuperFluxExtractor = function (
      signal,
      combine,
      frameSize,
      hopSize,
      ...
      return this.algorithms.SuperFluxExtractor(
        signal,
        combine,
        frameSize,
        hopSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SuperFluxNovelty = function (
      bands,
      binWidth,
      frameWidth,
    ) {
     ...
     * @memberof Essentia
     */
    Essentia.prototype.SuperFluxPeaks = function (
      novelty,
      combine,
      frameRate,
      pre_avg,
      ...
      return this.algorithms.SuperFluxPeaks(
        novelty,
        combine,
        frameRate,
        pre_avg,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.TempoScaleBands = function (
      bands,
      bandsGain,
      frameTime,
    ) {
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.TempoTap = function (
      featuresFrame,
      frameHop,
      frameSize,
      maxTempo,
      ...
      return this.algorithms.TempoTap(
        featuresFrame,
        frameHop,
        frameSize,
        maxTempo,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.TempoTapDegara = function (
      onsetDetections,
      maxTempo,
      minTempo,
      resample,
      ...
      return this.algorithms.TempoTapDegara(
        onsetDetections,
        maxTempo,
        minTempo,
        resample,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.TempoTapTicks = function (
      periods,
      phases,
      frameHop,
      hopSize,
      ...
      return this.algorithms.TempoTapTicks(
        periods,
        phases,
        frameHop,
        hopSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.TonalExtractor = function (
      signal,
      frameSize,
      hopSize,
      tuningFrequency,
      ...
      return this.algorithms.TonalExtractor(
        signal,
        frameSize,
        hopSize,
        tuningFrequency,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.TonicIndianArtMusic = function (
      signal,
      binResolution,
      frameSize,
      harmonicWeight,
      ...
      return this.algorithms.TonicIndianArtMusic(
        signal,
        binResolution,
        frameSize,
        harmonicWeight,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.TriangularBands = function (
      spectrum,
      frequencyBands,
      inputSize,
      log,
      ...
      if (frequencyBands === void 0) {
        frequencyBands = [
          21.533203125, 43.06640625, 64.599609375, 86.1328125, 107.666015625,
          129.19921875, 150.732421875, 172.265625, 193.798828125, 215.33203125,
          236.865234375, 258.3984375, 279.931640625, 301.46484375,
          322.998046875, 344.53125, 366.064453125, 387.59765625, 409.130859375,
          430.6640625, 452.197265625, 473.73046875, 495.263671875, 516.796875,
          538.330078125, 559.86328125, 581.396484375, 602.9296875,
          624.462890625, 645.99609375, 667.529296875, 689.0625, 710.595703125,
          732.12890625, 753.662109375, 775.1953125, 796.728515625,
          839.794921875, 861.328125, 882.861328125, 904.39453125, 925.927734375,
          968.994140625, 990.52734375, 1012.06054688, 1055.12695312,
          1076.66015625, 1098.19335938, 1141.25976562, 1184.32617188,
          1205.859375, 1248.92578125, 1270.45898438, 1313.52539062,
          1356.59179688, 1399.65820312, 1442.72460938, 1485.79101562,
          1528.85742188, 1571.92382812, 1614.99023438, 1658.05664062,
          1701.12304688, 1765.72265625, 1808.7890625, 1873.38867188,
          1916.45507812, 1981.0546875, 2024.12109375, 2088.72070312,
          2153.3203125, 2217.91992188, 2282.51953125, 2347.11914062, 2411.71875,
          2497.8515625, 2562.45117188, 2627.05078125, 2713.18359375,
          2799.31640625, 2885.44921875, 2950.04882812, 3036.18164062,
          3143.84765625, 3229.98046875, 3316.11328125, 3423.77929688,
          3509.91210938, 3617.578125, 3725.24414062, 3832.91015625,
          3940.57617188, 4069.77539062, 4177.44140625, 4306.640625,
          4435.83984375, 4565.0390625, 4694.23828125, 4844.97070312,
          4974.16992188, 5124.90234375, 5275.63476562, 5426.3671875,
          5577.09960938, 5749.36523438, 5921.63085938, 6093.89648438,
          6266.16210938, 6459.9609375, 6653.75976562, 6847.55859375,
          7041.35742188, 7256.68945312, 7450.48828125, 7687.35351562,
          7902.68554688, 8139.55078125, 8376.41601562, 8613.28125, 8871.6796875,
          9130.078125, 9388.4765625, 9668.40820312, 9948.33984375,
          10249.8046875, 10551.2695312, 10852.734375, 11175.7324219,
          11498.7304688, 11843.2617188, 12187.7929688, 12553.8574219,
          12919.921875, 13285.9863281, 13673.5839844, 14082.7148438,
          14491.8457031, 14922.5097656, 15353.1738281, 15805.3710938,
          16257.5683594,
        ];
      }
      if (inputSize === void 0) {
      ...
      return this.algorithms.TriangularBands(
        spectrum,
        vecfrequencyBands,
        inputSize,
        log,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.TriangularBarkBands = function (
      spectrum,
      highFrequencyBound,
      inputSize,
      log,
      ...
      return this.algorithms.TriangularBarkBands(
        spectrum,
        highFrequencyBound,
        inputSize,
        log,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.Trimmer = function (
      signal,
      checkRange,
      endTime,
      sampleRate,
      ...
      return this.algorithms.Trimmer(
        signal,
        checkRange,
        endTime,
        sampleRate,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.TruePeakDetector = function (
      signal,
      blockDC,
      emphasise,
      oversamplingFactor,
      ...
      return this.algorithms.TruePeakDetector(
        signal,
        blockDC,
        emphasise,
        oversamplingFactor,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.TuningFrequency = function (
      frequencies,
      magnitudes,
      resolution,
    ) {
      ...
      return this.algorithms.TuningFrequency(
        frequencies,
        magnitudes,
        resolution,
      );
     ...
     * @memberof Essentia
     */
    Essentia.prototype.TuningFrequencyExtractor = function (
      signal,
      frameSize,
      hopSize,
    ) {
      ...
      return this.algorithms.TuningFrequencyExtractor(
        signal,
        frameSize,
        hopSize,
      );
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.UnaryOperatorStream = function (
      array,
      scale,
      shift,
      type,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Vibrato = function (
      pitch,
      maxExtend,
      maxFrequency,
      minExtend,
      ...
      return this.algorithms.Vibrato(
        pitch,
        maxExtend,
        maxFrequency,
        minExtend,
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.WarpedAutoCorrelation = function (
      array,
      maxLag,
      sampleRate,
    ) {
    ...
    /**
        ...
        * @memberof Essentia
        */
    Essentia.prototype.Welch = function (
      frame,
      averagingFrames,
      fftSize,
      frameSize,
     ...
     * @memberof Essentia
     */
    Essentia.prototype.Windowing = function (
      frame,
      normalized,
      size,
      type,
      ...
      return this.algorithms.Windowing(
        frame,
        normalized,
        size,
        type,
